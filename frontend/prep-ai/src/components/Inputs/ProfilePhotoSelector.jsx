    ...
    <div className="flex justify-center mb-6">
      ...
      {!image ? (
        ...
        <div className="relative">
          ...
          <button className="w-8 h-8 rounded-full flex items-center justify-center bg-red-500 text-white absolute -bottom-1 -right-1 cursor-pointer" type="button" onClick={handleRemoveImage}>
            <LuTrash />
          </button>
        </div>
      )}
